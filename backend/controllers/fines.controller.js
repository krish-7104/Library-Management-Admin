...
const GetAllFinesHandler = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, fines, "All Fines Get Successfully!"));
  } catch (error) {
...
const finePaidHandler = async (req, res) => {
  try {
    ...
    return res
      .status(201)
      .json(new ApiResponse(201, [], "Fine Paid Record Added!"));
  } catch (error) {
...
const deleteFineHandler = async (req, res) => {
  try {
    ...
    return res
      .status(201)
      .json(new ApiResponse(201, [], "Fine Record Deleted!"));
  } catch (error) {
...
const GetCountHandler = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, data, "Fines Count Found!"));
  } catch (error) {
    return res
      .status(500)
      .json(new ApiResponse(500, [], "Internal Server Error"));
